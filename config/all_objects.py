...
debug = True
max_epochs=1000
camou_path="/scratch/tkg5kq/av_project/multifusion_mask/workdir/20251112_115848/1camou.npy"

################# ablation ###################
freq = 0
num_samples=5
allowed_words='./all_words.txt'
dynamic_ratio=False # FIXME change to that if the area_ratio is -1 use dynamic
area_ratio=.002
gamma_heatmap = 1
gamma_cls = 0
gamma_bbox = 0
